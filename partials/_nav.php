...
echo '<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        if($loggedin){
          ...
          echo '
          <button type="button" class="btn btn-dark mx-2"  data-toggle="modal" data-target="#loginModal">Login</button>
          <button type="button" class="btn btn-dark mx-2"  data-toggle="modal" data-target="#signupModal">SignUp</button>';
        }
