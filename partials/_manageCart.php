...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_POST['checkout'])) {
        ...
        if (password_verify($password, $passRow['password'])){ 
            ...
            $sql = "INSERT INTO `deliverydetails` ( `orderId`, `deliveryBoyName`, `deliveryBoyPhoneNo`, `deliveryTime`, `dateTime`) VALUES ( '$orderId', 'Wheels', '0593687636', '50', current_timestamp())";
            $result = mysqli_query($conn, $sql);
            if ($result){
