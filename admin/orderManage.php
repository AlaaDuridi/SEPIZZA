    ...
    <div class="table-wrapper">
        <div class="table-title" style="border-radius: 14px;">
            <div class="row">
                ...
                <div class="col-sm-8">						
                    <a href="" class="btn" style="background-color:#3d2729; color:white;"><i class="material-icons">&#xE863;</i> <span>Refresh List</span></a>
                    <a href="#" onclick="window.print()" class="btn btn-info" style="color:#3d2729"><i class="material-icons">&#xE24D;</i> <span>Print</span></a>
                </div>
            </div>
        </div>
...
<style>
    ...
    .table-wrapper .btn.btn-dark {
        color: #fff;
        background: #03A9F4;
    }
    .table-wrapper .btn.btn-dark:hover {
        background: #03a3e7;
    }
    .table-title .btn {		
        font-size: 13px;
