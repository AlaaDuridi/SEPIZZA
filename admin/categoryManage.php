        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="partials/_categoryManage.php" method="post" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-header" style="background-color: #3d2729; color:white;">
                            Create New Category
                        </div>
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-md-12">
                                    <button type="submit" name="createCategory" class="btn btn-sm btn-dark col-sm-3 offset-md-4"> Create </button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-8 mb-3">
                <div class="card">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        <thead style="background-color: #3d2729; color:white">
                        <tr>
                            ...
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                echo '<tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button class="btn btn-sm btn-dark edit_cat" type="button" data-toggle="modal" data-target="#updateCat' .$catId. '">Edit</button>
...
<div class="modal fade" id="updateCat<?php echo $catId; ?>" tabindex="-1" role="dialog" aria-labelledby="updateCat<?php echo $catId; ?>" aria-hidden="true" style="width: -webkit-fill-available;">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color: #3d2729; color:white;">
