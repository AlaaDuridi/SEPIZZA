...
<body>
    ...
    <div>&nbsp;
        <a href="index.php#ourmenu" class="active text-light">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                        <div class="xcard card" style="width: 20rem;height:500px ;">
                            <img src="img/pizza-'.$pizzaId. '.jpg" class="type card-img-top" alt="image for this pizza" width="250px" height="280px">
                            <div class="card-body">
                                <h5 class="card-title">' . substr($pizzaName, 0, 20). '...</h5>
                                <h6 style="color: #ff0000">NIS. '.$pizzaPrice. '</h6>
                                ...
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        echo '<form action="partials/_manageCart.php" method="POST">
                                              ...
                                              <button type="submit" name="addToCart" class="xbtn btn btn-primary mx-2">Add to Cart</button>';
                                    }else {
                                        echo '<a href="viewCart.php"><button class="xbtn btn btn-primary mx-2">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="xbtn btn btn-primary mx-2" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                            echo '</form>                            
