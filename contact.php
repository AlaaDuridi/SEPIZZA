  ...
  <?php if($loggedin) { ?>
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                      <span class="input-group-text" id="basic-addon">+97</span>
                                    </div>
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(assets/img/slide/1.jpg);background-size:cover;">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              ...
                              <a href="https://github.com/AlaaDuridi" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
                              <a href="https://www.youtube.com/channel/UC9Ia41Nr3FHM8-yeHXA2eHw" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-youtube"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
            ...
            <div class="modal-body" id="bd">
              <table class="table-striped table-bordered col-md-12 text-center">
                <thead style="background-color: rgb(0 0 0);">
                    <tr>
                        <th style="color:#fff;">Contact Id</th>
      ...
      <?php }else {
        ...
        <div class="alert alert-dark my-3">
            <font style="font-size:22px"><center>Contact US. You need to <strong><a class="alert-link" data-toggle="modal" data-target="#loginModal">Login</a></strong></center></font>
        </div></div>';
    }?>
